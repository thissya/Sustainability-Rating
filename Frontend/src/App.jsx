      ...
      <form onSubmit={handleSubmit}>
        <div className="flex space-x-4">
          ...
          <div className="w-1/2">
            ...
            <input className="w-full p-1 border rounded" id="DietType" type="text" placeholder="Diet Type" value={formData.DietType} onChange={handleChange} />
          </div>
        </div>
        ...
        <div className="flex space-x-4">
          ...
          <div className="w-1/2">
            <label className="block text-gray-700">Energy Source</label>
            <input className="w-full p-1 border rounded" id="EnergySource" type="text" placeholder="Energy Source" value={formData.EnergySource} onChange={handleChange} />
          </div>
        </div>
